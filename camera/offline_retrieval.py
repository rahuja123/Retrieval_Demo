...
def offline_retrieval(query="static/query/query.png",cam_name_list=['S1-B4b-L-B'],rank=10,date, start_datetime, end_datetime, reid_model='ResNet50', reid_weight='ResNet50_Market.pth', reid_device='cpu'):
